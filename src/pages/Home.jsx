    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          <ul className="list-group">
            <li className='list-group-item'><a class="nav-link" href={signed} target='_blank'>แนวนโยบายและแนวปฏิบัติในการรักษาความม่ันคงปลอดภัยด้านสารสนเทศ <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" width={20} alt="" /></a></li>
            ...
            <li className='list-group-item'><a class="nav-link" href={pdo} target='_blank'>คำสั่งแต่งตั้งเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล DPO<img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" width={20} alt="" /></a></li>
      ...
      <div className="container text-center mt-5">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md mb-5">
            <a href={cyber15062023} target="_blank">
